...
type AddRequest struct {
	...
	Status               Status   `protobuf:"varint,3,opt,name=status,proto3,enum=longman.Status" json:"status,omitempty"`
...
type UpdateRequest struct {
	...
	Status               Status   `protobuf:"varint,4,opt,name=status,proto3,enum=longman.Status" json:"status,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type Word struct {
	...
	LastModifiedTime     *timestamp.Timestamp `protobuf:"bytes,6,opt,name=lastModifiedTime,proto3" json:"lastModifiedTime,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func init() {
	proto.RegisterEnum("longman.Status", Status_name, Status_value)
...
var fileDescriptor_75c5b1ffbf8ec17c = []byte{
	...
	,
}
